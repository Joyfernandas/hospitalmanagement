...
<div className="sidebar pe-4 pb-3">
    <nav className="navbar bg-light navbar-light">
      ...
      <div className="navbar-nav w-100">
        ...
        <Link to="widget.html" className="nav-item nav-link"><i className="fa fa-th me-2" />Widgets</Link>
        <Link to="form.html" className="nav-item nav-link"><i className="fa fa-keyboard me-2" />Forms</Link>
        <Link to="table.html" className="nav-item nav-link"><i className="fa fa-table me-2" />Tables</Link>
        <Link to="chart.html" className="nav-item nav-link"><i className="fa fa-chart-bar me-2" />Charts</Link>
        <div className="nav-item dropdown">
